...
namespace BerestovFirstLab
{
    ...
    public partial class MainWindow : Window
    {
        ...
        void HistoryChoise(string path)
        {
            if (path != null)
            {
        ...
        /// <param name="e"></param>
        void HandlerClick(object sender, RoutedEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        void Know_Click(object sender, RoutedEventArgs e) => ClearChoise();
        ...
        void listNameImg_GotMouseCapture(object sender, System.Windows.Input.MouseEventArgs e)
        {
        }

        void listNameImg_GotMouseCapture_1(object sender, System.Windows.Input.MouseEventArgs e)
        {
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        void listNameImg_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
        ...
        void GetInfoElements_Click(object sender, RoutedEventArgs e) => GetInfoElement();

        void GetInfoSizeScreen_Click(object sender, RoutedEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        void Window_SizeChanged(object sender, SizeChangedEventArgs e) => MediaQuary();
    }
}